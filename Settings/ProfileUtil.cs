...
namespace EXRScreenshot.Settings
{
    public static class ProfileUtils
    {
        ...
        private static EXRScreenshotProfile CreateDefault(Setting settings)
        {
            _ = EnsureDataDirectory();
        ...
        public static List<EXRScreenshotProfile> ReadProfiles(Setting settings)
        {
            ...
            if (dir.Exists) //check if the directory exists
            {
                ...
                foreach (var fileInfo in files) //iterate through the files
                {
                    try
                    {
                ...
                if (profiles.FirstOrDefault(p => p.ID == EXRScreenshotProfile.DefaultID) ==
                    null) //if default profile does not exist
                {
        ...
        // Saves a profile.
        private static void Save(EXRScreenshotProfile profile)
        {
            _ = EnsureDataDirectory();
